...
<h4><b>FILTER & Sort by category</b></h4>
 <form  method="post" action="indexfiltr.php?go"  id="searchform"> 
  <table>
  <tr>
  ...
  { 
   ...
   { 
     ...
     //-query  the database table 
        $sql="SELECT * FROM salfilter WHERE type LIKE '$_POST[tp]'  AND  location LIKE '$_POST[bd]' AND location LIKE '$_POST[ln]' AND  gender LIKE '$_POST[gr]' AND  offers LIKE '$_POST[of]'"; 
